...
doublep = np.loadtxt("./passthroughx2/http", dtype='float')
hobfs1 = np.loadtxt("./hobfsx1_unsecure/http_v2", dtype='float')
hobfs2u = np.loadtxt("./hobfsx2_unsecure/http_v2", dtype='float')
hobfs2s = np.loadtxt("./hobfsx2_secure/http_v2", dtype='float')
