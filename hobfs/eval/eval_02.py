...
hobfs1v1 = np.loadtxt("./hobfsx1_unsecure/iperf", dtype='float')
#hobfs2uv1 = np.loadtxt("./hobfsx2_unsecure/ping", dtype='int')
hobfs1v2 = np.loadtxt("./hobfsx1_unsecure/iperf_v2", dtype='float')
...
fig.savefig('iperf_v1_v2.png', bbox_inches='tight')
