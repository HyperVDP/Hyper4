...
table t_drop_31 { actions { a_drop; }}
table t_drop_32 { actions { a_drop; }}
table t_drop_33 { actions { a_drop; }}
...
control do_drop_31 { apply(t_drop_31); }
control do_drop_32 { apply(t_drop_32); }
control do_drop_33 { apply(t_drop_33); }
